  ...
  return (
    <div className="w-full flex flex-col-reverse lg:flex-row justify-between items-center gap-20 px-2 md:px-6">
      <div className="flex-1 relative w-full lg:w-auto">
        ...
        {/* <div className="px-3 py-2 hidden sm:block absolute bottom-42 right-2 sm:right-20 bg-yellow-500/20 rounded-[6px] w-max font-medium dark:text-yellow-300 text-yellow-500 border border-yellow-500/20 animate-wiggle duration-1000">
          React Native
        </div> */}
        ...
        <div className="text-lg text-zinc-600 dark:text-zinc-400 my-6 md:my-10 font-bold">
          ...
          <span className="font-normal italic">
            Desenvolvo aplicações mobile escaláveis e modernas com código limpo,
            eficiente e com foco na experiência do usuário
          </span>
          📱✨
        </div>
      </div>
